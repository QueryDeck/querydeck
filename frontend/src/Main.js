...
const Main = props => {
  const [alerts, setAlerts] = useState(getItemFromStore('alerts', settings.alerts));
  ...
  const [navbarDisplay, setNavbarDisplay] = useState(getItemFromStore('navbarDisplay', settings.navbarDisplay));
