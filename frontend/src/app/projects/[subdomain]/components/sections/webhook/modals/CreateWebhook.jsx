...
const CreateWebhook = (props) => {
  ...
  const [algorithmList] = useState([
    { label: "/film/sdf", value: "algorithm1" },
    { label: "/film/sdf2", value: "algorithm2" },
    { label: "/film/sdf3", value: "algorithm3" },
  ]);
  ...
  const [tableOptions] = useState(null);
  ...
  //       let currSelected = tableData.options.find(
  ...
  //     columnHandler(
  //       {
  //         label: auth.user_id_column_name || "",
  //         value: auth.user_id_column_id || "",
  //       } || {}
  //     );
      ...
      return (
        ...
        >
          <Label className="list-card-label">
            Http Handler
            <Input
              placeholder={"Enter http handler "}
              type="text"
          ...
          <Label className="list-card-label security-auth-dropdown-bx">
            ...
            <Select
              ...
              hideSelectedOptions
              noOptionsMessage={() => "No Endpoint match the search term"}
  ...
  return (
    ...
    >
      <ModalHeader className="modal-header clearfix">
        <div className="float-left">Create Webhook</div>
        <Button
      ...
      <ModalFooter>
        <div className="query-modal-columns-vanilla-footer">
          <Button block color="falcon-danger" onClick={props.toggleModalState}>
            Close &nbsp;
            <FontAwesomeIcon icon={faTimes} />
          </Button>
          &nbsp;&nbsp;&nbsp;
          <Button
            ...
            //   !Boolean(alogorithm) ||
            //   !Boolean(roleSessionKey?.length) ||
            //   !Boolean(userSessionKey.length) ||
